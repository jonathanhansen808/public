...
signoutbtn.addEventListener("click", (e) => {
    content.innerHTML = `<div class="container" id="content">
    <iframe
        ...
        style="border:solid 2px rgb(48, 84, 201)" width="900" height="600" frameborder="0"
        scrolling="no"></iframe>
    <p
...
<div id="trade_search" class="loggedin">
    <p
        class="has-background-danger-dark p-1 mt-5 menu-label has-text-centered  has-text-white has-text-weight-bold is-size-4">
        Click Available Trade button to see open trades below.</p>
</div>
<div id="content2">
    <img src="/GroupProjectFinal/public/images/Screenshot 2022-04-25 185030.png" alt="">
</div>
</div>`;
    auth.signOut().
    then((msg) => {
